...
//省份
const G_ProvinceArr = ["省份", "北京市", "天津市", "上海市", "重庆市", "河北省", "河南省", "云南省", "辽宁省", "黑龙江省", "湖南省", "安徽省", "山东省", "新疆维吾尔自治区", "江苏省", "浙江省", "江西省", "湖北省", "广西壮族", "甘肃省", "山西省", "内蒙古自治区", "陕西省", "吉林省", "福建省", "贵州省", "广东省", "青海省", "西藏", "四川省", "宁夏回族", "海南省", "台湾省", "香港特别行政区", "澳门特别行政区"];
//城市
const G_CityArr = [
    ['市县'],
...
//常量定义 end >>>>>>>>>>>>>>>>>>>>>
//TODO: 从CITY_DATA3 中 整理出 {'编码':'名称'} 保存到CD3_SN_TEXT_OBJ; {省编码:[省下属市数组]} 到 CD3_P_CS_OBJ
let CD3_SN_TEXT_OBJ = {};
let CD3_P_CS_OBJ = {};
for (var i = 0, len = CITY_DATA3.length; i < len; i++) {
    var obj_1 = CITY_DATA3[i];
    CD3_SN_TEXT_OBJ[obj_1.value] = obj_1.text;
    if (obj_1.children) {
        CD3_P_CS_OBJ[obj_1.value] = obj_1.children;
        for (var i2 = 0, len2 = obj_1.children.length; i2 < len2; i2++) {
            var obj_2 = obj_1.children[i2];
            CD3_SN_TEXT_OBJ[obj_2.value] = obj_2.text;
            if (obj_2.children) {
                for (var i3 = 0, len3 = obj_2.children.length; i3 < len3; i3++) {
                    var obj_3 = obj_2.children[i3];
                    CD3_SN_TEXT_OBJ[obj_3.value] = obj_3.text;
                }
            }
        }
    }
...
export default{
    diqu:CITY_DATA3,
    sheng:G_ProvinceArr,//省份
    shengshiqu_3:CD3_SN_TEXT_OBJ,//编号+名称
    shengshiqu_1:CD3_P_CS_OBJ//省份编号+下层
}
